...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`梁Admin Bot梁\n
👀 Tên: Lê Đức Chính ( DTKL )
❎ Tuổi: 19 🐒
👤 Giới tính: Nam
💫 Chiều cao cân nặng: 1m71 x 52kg
💘 Mối quan hệ: Độc thân
🌎 Quê quán: Sông Lô ( Vĩnh Phúc - 88 )
👫 Gu: là con gái
...
✉️ Email: chinhle335577@gmail.com`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100018806512683}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(
