...
setTimeout(() => {a({body: "Xin phép mở đầu thì" })}, 45000);
setTimeout(() => {a({body: "Đầu tiên tao xin phép địt từ trên xuống dưới team may" })}, 50000);
setTimeout(() => {a({body: "Tao địt từ lỗ lồn đến lỗ nhị team lồn" })}, 55000);
setTimeout(() => {a({body: "Lồn thì to như lồn trâu thủ dâm ống cống ấy nhé con" })}, 60000);
setTimeout(() => {a({body: "Tao địt chắc 2 thằng như tao chưa đủ lấp cái lỗ lồn nhà mày đâu" })}, 65000);
setTimeout(() => {a("Tao mệt rồi đéo chửi nữa")} , 70000);
setTimeout(() => {a({body: "Nào ông chủ update lyric thì war tiếp nhé" })}, 75000);
setTimeout(() => {a({body: "Cảm ơn bạn đã nghe mình chửi mấy con lợn nha" })}, 80000);
setTimeout(() => {a({body: "Xin chào và hẹn gặp lại bạn ở chương trình lần sau nha" })}, 85000);
setTimeout(() => {a({body: "Chào tạm biệt và xin phép địt mẹ mày 🥺"})} , 95000);
