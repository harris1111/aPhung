...
module.exports.run = async function({ api, event, Users, Currencies }) {
        ...
        if(money = 5555) api.sendMessage("⚡️Nghèo quá và óc chó nữa nên tôi không biết ghép cho ai nhé xin vĩnh biệt cụ!") //thay số tiền cần trừ vào 0, xóa money = 0
        else {
        ...
        Currencies.setData(event.senderID, options = {money: money - 5555$}) //thay số $ cần trừ vào x, xóa 2 gạch đầu dòng này để thực hiện trừ tiền
